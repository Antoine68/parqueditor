...
public class FieldControl extends VBox {
	...
	private final ObservableList<Schema.Type> typeChoices = FXCollections.observableArrayList(
			Schema.Type.BOOLEAN, Schema.Type.DOUBLE, Schema.Type.FLOAT, Schema.Type.INT, Schema.Type.LONG, Schema.Type.STRING
	);
